...
def build_v6_finch():
    hf_script_builder(
        target_dir=f"{current_dir}/hf_code/v6_finch",
        ...
        build_file_name="modeling_blocks_rwkv6.py"
    )
...
def hf_script_builder(
    ...
    if source_cuda_dir is not None:
    ...
    compiled_code = [
        "# ========== AUTO GENERATED FILE =========",
        "# This file is auto generated by 'hf_builder.py'. As part of the 'RWKV/RWKV-block' project.",
        "# Do not edit this file directly. As it is not version controlled. And will be overwritten.",
        "#",
        "# Source Files:"
    ]
    ...
    # Add the cuda files list to the compiled code list
...
def hf_builder(args):
    ...
    if model_class == "v6_finch":
        build_v6_finch()
    elif model_class == "v7_goose":
        build_v7_goose()
    ...
    if model_class == "v6_finch":
        from hf_code.v6_finch.configuration_rwkv6 import RWKV6Config
        model_config = RWKV6Config.from_model_state_dict(state_dict, **hf_config)
    elif model_class == "v7_goose":
    ...
    if model_class == "v6_finch":
        config_json["auto_map"] = {
            ...
            "AutoModel": "modeling_rwkv6.RWKV6Model",
            "AutoModelForCausalLM": "modeling_rwkv6.RWKV6ForCausalLM"
        }
        config_json["architectures"] = ["RWKV6ForCausalLM", "RWKV6Model", "RWKV6PreTrainedModel"]
    elif model_class == "v7_goose":
        config_json["auto_map"] = {
