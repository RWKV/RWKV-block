...
def parse_args():
    ...
    parser.add_argument('--init-state-wkv', action='store_true',
                      help='Enable WKV state initialization')
    parser.add_argument('--forward-chunk-size', type=int, default=4096,
                      help='Size of forward chunks for processing')
    parser.add_argument('--padding-idx', type=int, default=151643,
                      help='Padding token index')
    
    # Hybrid model parameters
    parser.add_argument('--num-suffix-hybrid-layers', type=int, default=0,
                      help='Number of hybrid layers at the end')
    parser.add_argument('--num-prefix-hybrid-layers', type=int, default=0,
                      help='Number of hybrid layers at the start')
    parser.add_argument('--hybrid-num-attention-heads', type=int, default=1,
                      help='Number of attention heads in hybrid layers')
    parser.add_argument('--hybrid-num-key-value-heads', type=int, default=1,
    ...
    parser.add_argument('--v-first-with-embedding', action='store_true', default=True,
                      help='Use embedding for v_first')
    
    # Model specific parameters
    parser.add_argument('--use-rotary-pos-emb', action='store_true', default=True,
                      help='Use rotary positional embeddings')
    parser.add_argument('--hybrid-attention-dropout', type=float, default=0.0,
                      help='Dropout rate for hybrid attention layers')
    parser.add_argument('--hidden-size-att', type=int, default=None,
                      help='Size of attention hidden layer (defaults to hidden_size if not set)')
    parser.add_argument('--hidden-size-ffn', type=int, default=None,
    ...
    parser.add_argument('--tmix-backend', type=str, default='auto',
