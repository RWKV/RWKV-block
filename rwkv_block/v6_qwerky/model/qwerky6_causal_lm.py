...
from .qwerky6_model import Qwerky6Model

class Qwerky6CausalLM(nn.Module):
    def __init__(self, config: Union[Qwerky6ConfigMap, any]):
        super().__init__()
        self.config = Qwerky6ConfigMap.normalize(config)
        self.model = Qwerky6Model(self.config)
