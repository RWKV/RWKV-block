...
class Qwerky6LayerBlock(torch.nn.Module):
    def __init__(
            self, 
            configMap: Union[Qwerky6BlockConfigMap, RWKV6BlockConfigMap, any]
        ):
        super().__init__()

        # The configMap to use
        configMap = Qwerky6BlockConfigMap.normalize(configMap)
